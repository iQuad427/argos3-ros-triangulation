...
float CFootBotCommunication::m_distance;
float CFootBotCommunication::m_gradient;
float CFootBotCommunication::m_activation;

CFootBotCommunication::CFootBotCommunication() :
        m_pcWheels(nullptr),
...
void CFootBotCommunication::InitROS() {
    //get e-puck ID
...
void CFootBotCommunication::CallbackROS(const morpho_msgs::Direction::ConstPtr& msg) {
    m_gradient = msg->gradient;
    m_distance = msg->distance;
    m_activation = msg->activation;
}

void CFootBotCommunication::ControlStepROS() {
    if (ros::ok()) {
        // Publish the message
...
void CFootBotCommunication::Init(TConfigurationNode &t_node) {
...
void CFootBotCommunication::Reset() {
...
void CFootBotCommunication::ControlStep() {
 ...
 */
REGISTER_CONTROLLER(CFootBotCommunication, "footbot_communication_controller")
